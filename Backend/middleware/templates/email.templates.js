/**
 * Email sent to the organisation when a new application arrives.
 */
    ...
    <div style="font-family:sans-serif;max-width:600px;margin:auto;color:#222;">
      ...
      <div style="padding:32px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 8px 8px;">
        ...
        <p style="margin-top:32px;color:#6b7280;font-size:13px;">
          Global Alliance for Mission ·
          <a href="https://globalallianceorg.netlify.app" style="color:#1a4731;">globalallianceorg.netlify.app</a>
        </p>
      </div>
    </div>`;
}
